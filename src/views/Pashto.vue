    ...
    <div class="row align-items-center text-center text-md-start">
      <div class="col-12 col-md-4 mb-4 mb-md-0">
        <h1 class="display-1 fw-bold">
          <i class="fa-solid fa-graduation-cap me-2"></i><i>Learn</i
          ><br />Pashto
        </h1>
      </div>
      ...
      <div class="col-12 col-md-8">
        <p class="fs-1 fw-bold">
          Join me on a journey to learn Pashto, a beautiful language with strong
          cultures in countries like Afghanistan and Pakistan.
        </p>
      </div>
    </div>
